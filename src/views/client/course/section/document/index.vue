...
function handleDocumentLoad({ numPages }) {
  currentPage.value = numPages || 0
  console.log('🚀 ~ file: index.vue:101 ~ currentPage.value:', currentPage.value)
}
...
<template>
  ...
  >
        ...
        >
          ...
          >
            <van-icon
              ...
              size="16"
            />
            第 {{ courseDocumentInfo.pdfStudyPage || 1 }} 页
          </span>
        </div>
      </div>
    </div>
    ...
    <div
      class="min-h-90 overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 shadow-[0_10px_24px_rgb(15_23_42/6%)]"
    >
      <div
        v-if="loading"
