...
function goToAddSection(type: 'video' | 'document' | 'exam' | 'question') {
  const routeMap = {
    ...
    video: 'AdminMyCourseSectionVideo',

    document: 'AdminMyCourseSectionDocument',

    exam: 'AdminMyCourseSectionExam',

    question: 'AdminMyCourseSectionQuestion',
