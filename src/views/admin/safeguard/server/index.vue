...
/**
   ...
   * 模拟服务器资源使用情况的实时变化
   */
function updateServerData(): void {
...
<template>
  ...
  >
    ...
    >
      <div
        class="flex flex-wrap w-[calc(100%+20px)]"
      >
        <div
        ...
        >
          ...
          >
            <div
              class="mx-10 max-lg:m-0 max-lg:mr-5 max-md:m-0"
            >
              <img
              ...
              <div
                class="flex justify-center -mt-2.5 max-md:mt-2.5"
              >
                <ElButtonGroup>
                  <ElButton
                    type="primary"
            ...
            <div
              class="flex-1 mt-1 max-lg:mt-0 max-md:mt-7.5"
            >
              <div
                class="my-3.5"
              >
