...
/**
   * 打开评论详情抽屉
   */
function openDrawer(item: CommentItem) {
...
<template>
  <div>
    <h1
      class="text-4xl font-medium mt-5"
    >
      留言墙
    </h1>

    <p
      class="mt-3.5 text-g-600"
    >
    ...
    >
      ...
      >
        ...
        <div
          class="absolute bottom-4 left-0 px-4 flex-cb w-full"
        >
          <div
            class="flex-c"
          >
            <div
              class="flex-c mr-5 text-xs text-g-600"
            >
              <ArtSvgIcon
                icon="ri:heart-line"
