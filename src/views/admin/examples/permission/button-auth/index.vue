...
// 获取角色标签类型
function getRoleTagType(role: string): 'primary' | 'success' | 'info' | 'warning' | 'danger' {
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            <span
              class="min-w-20 font-semibold"
            >用户角色：</span>

            <ElTag
              :type="getRoleTagType(currentUserRole)"
            >
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            <h4
              class="m-0 mb-2 text-sm font-semibold"
            >
              当前路由权限配置：
            </h4>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  class="text-g-700"
                >检查路由 meta.authList 中是否存在 authMark: 'add'</span>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <span
                  class="text-g-700"
                >检查路由 meta.authList 中是否存在 authMark: 'edit'</span>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <span
                  class="text-g-700"
                >检查路由 meta.authList 中是否存在 authMark: 'delete'</span>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <span
                  class="text-g-700"
                >检查路由 meta.authList 中是否存在 authMark: 'export'</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  class="text-g-700"
                >检查用户 buttons 数组是否包含 'publish'</span>
              </div>
            </div>
            ...
            >
              ...
              >
                <ElButton
                  :type="hasBatchPermissions ? 'warning' : 'info'"
                >
                  批量操作
                  <ElIcon
                    class="el-icon--right"
