...
// 获取角色标签类型
function getRoleTagType(role?: string): 'info' | 'warning' | 'primary' | 'success' | 'danger' {
  if (!role) { return 'info' }
...
/**
   ...
   * @param account 账号信息
   */
async function switchRole(account: AccountInfo) {
  try {
...
<template>
  ...
  >
    ...
    >
      ...
      <p
        class="m-0 leading-[1.6] text-g-700"
      >
    ...
    >
      ...
      >
        ...
        <div>
          <div>
            <div
              class="flex items-start mb-3 last:mb-0"
            >
              <span
            ...
            >
              ...
              <ElTag
                :type="getRoleTagType(currentUser.roles?.[0])"
              >
          ...
          >
            ...
            >
              <div>
                ...
                <p
                  class="m-0 mb-2 leading-[1.5] text-g-700"
                >
                  {{ account.description }}
                </p>
