...
const routePath = '/admin/examples/tabs'

/**
   * 更新当前标签页标题
   * 验证输入内容后调用 store 方法更新标题
   */
function handleUpdateTabTitle(): void {
...
<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <ElButton
          ...
          @click="handleUpdateTabTitle"
        >
          修改
        </ElButton>

        <ElButton
          @click="handleResetTabTitle"
        >
          重置
        </ElButton>
      </div>
    ...
    >
      ...
      >
        <p
          class="m-0 mb-2 text-sm text-g-600"
        >
          当前标签页信息：{{ currentTab }}
        </p>
      </div>
      ...
      >
        ...
        >
          <ElButton
            type="success"
            plain
            @click="handleGetCurrentTabTitle(routePath)"
          >
            获取当前标签页信息
          </ElButton>
        </ElCol>
      ...
      >
        ...
        >
          <ElButton
            type="danger"
            plain
            @click="handleCloseTab(routePath)"
          >
            关闭当前标签
          </ElButton>
          ...
          <ElButton
            type="warning"
            plain
            @click="handleCloseOthersTab(routePath)"
          >
            关闭其他标签
          </ElButton>
