...
/**
   * 添加消息记录
   */
function addMessage(type: 'sent' | 'received', content: string) {
...
<template>
  <div
    class="page-content mb-5"
  >
    <div
      class="mb-15 text-center"
    >
      <h1
        class="my-4 text-2xl font-semibold leading-tight"
      >
        WebSocket 连接示例
      </h1>

      <p
        class="m-0 text-base leading-relaxed text-g-700"
      >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              class="text-2xl font-bold text-blue-500 mb-1"
            >
              {{ messageCount }}
            </div>
      ...
      >
        ...
        >
          ...
          >
            <div
              class="text-2xl font-bold text-amber-500 mb-1"
            >
              {{ reconnectCount }}
            </div>
        ...
        >
          ...
          >
            ...
            >
              <ElSpace>
                <ElCheckbox
                  v-model="connectForm.autoReconnect"
                >
                  自动重连
                </ElCheckbox>

                <ElCheckbox
                  v-model="connectForm.heartbeat"
                >
                  心跳检测
                </ElCheckbox>
              </ElSpace>
