...
<template>
  ...
  >
    ...
    >
      <h2
        class="m-0 mb-6 text-xl font-medium"
      >
        基础用法
      </h2>
    ...
    >
      ...
      <div
        class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 mb-8"
      >
        <div
        ...
        >
          <div
            class="mb-3 text-sm font-medium text-g-700"
          >
            {{ easing.name }}
          </div>
