...
<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h2
              style="margin: 0; font-size: 1.6rem; color: #fff !important"
            >
              智能组件系统
            </h2>
          </template>
          ...
          >
            ...
            >
              <p
                style="position: relative; z-index: 10; font-style: italic"
              >
                灵活配置，强大扩展，支持自定义插槽内容
              </p>
            </div>
    ...
    >
      ...
      >
        <ArtBasicBanner
          v-bind="PresetBanners.marketing"
        />
      </ElCol>
