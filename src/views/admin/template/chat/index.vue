...
<template>
  ...
  >
    ...
    <div
      class="box-border flex-1 h-full max-md:h-[calc(70%-30px)]"
    >
      <div
        class="flex-cb pt-4 px-4 pb-0 mb-5"
      >
        <div>
          <span
            class="text-base font-medium"
      ...
      <div
        class="flex flex-col h-[calc(100%-85px)]"
      >
        <!-- 聊天消息区域 -->
        <div
        ...
        >
          ...
          >
            <div
              class="flex gap-2 items-start w-full mb-7.5"
              :class="[
