...
<template>
  ...
  >
    ...
    >
      <h1
        class="mb-2 text-4xl font-medium max-sm:text-3xl"
      >
        超过 53,476 位信赖的开发者
      </h1>

      <h2
        class="mb-2.5 text-2xl font-normal text-g-600 max-sm:text-2xl"
      >
        以及众多科技巨头的选择
      </h2>

      <div
        class="gap-2 flex-cc mt-2.5 max-sm:mt-3.5 max-sm:!block"
      >
        <p
          class="text-sm italic text-g-600 max-sm:text-sm"
        >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h3
                class="mb-2.5 text-xl font-medium"
              >
                {{ plan.title }}
              </h3>
              ...
              >
                ...
                <span
                  class="ml-2.5 text-sm text-g-600"
                >/一次性付款</span>
              </div>
            </div>
            ...
            >
              ...
              >
                <ElIcon
                  class="mr-2.5"
                  :class="feature.available ? '!text-theme' : '!text-danger'"
                >
                  <Check
