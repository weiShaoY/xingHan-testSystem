...
<script lang="ts" setup>
  ...
  import { Delete, Folder, QuestionFilled, Select, Top, View } from '@element-plus/icons-vue'
  ...
  <div class="w-full">
    ...
    <el-page-header @back="$router.back()">
      ...
      <template #extra>
        <div class="flex items-center">
          <el-button type="primary" class="ml-2"> 完成 </el-button>
        </div>
      </template>
    </el-page-header>
    ...
    <div class="mt-10">
      <el-tabs v-model="activeTab" class="">
        <el-tab-pane label="目录编辑" name="basic" class="mt-5 border rounded-3 p-6">
          <!-- 阶段管理 -->
          <div class="mt-5">
            <!-- 阶段标签页 -->
            <el-tabs
              ...
              >
                <el-form label-position="left" label-width="120px">
                  <el-form-item label="阶段名称" required>
                    <el-input v-model="stage.name" placeholder="请输入阶段名称" class="w-full" />
                  </el-form-item>
                  ...
                  <el-form-item label="课程" required>
                    ...
                    <el-button class="mt-2" type="primary" plain @click="addCourse(index)">
                      + 添加课程
                    </el-button>
                  </el-form-item>
                </el-form>
        ...
        <el-tab-pane label="高级设置" name="advanced" class="px-0">
          <!-- 高级设置内容 -->
          <div class="mt-5 border rounded-3 p-6">
            <!-- 设置多个学习阶段 -->
            <div class="mb-6">
              <div class="mb-2 flex items-center justify-between">
                <span class="font-medium">设置多个学习阶段</span>

                <el-tooltip content="开启后可以创建多个学习阶段" placement="top">
            ...
            <div class="mb-6">
              <div class="mb-2 flex items-center">
                <span class="font-medium">解锁条件</span>

                <el-tooltip content="设置课程的解锁方式" placement="top">
                  <el-button link size="small" class="ml-2">
                    <el-icon>
                      <QuestionFilled />
                    </el-icon>
                  </el-button>
              ...
              <el-radio-group v-model="advancedSettings.unlockCondition">
                <el-radio value="stage"> 按学习阶段解锁 </el-radio>

                <el-radio value="course"> 按课程解锁 </el-radio>

                <el-radio value="none"> 不限定学习顺序 </el-radio>
              </el-radio-group>
            </div>
            ...
            <div class="mb-6">
              <div class="mb-2 flex items-center">
                <span class="font-medium">展示方式</span>

                <el-tooltip content="设置课程的展示方式" placement="top">
                  <el-button link size="small" class="ml-2">
                    <el-icon>
                      <QuestionFilled />
                    </el-icon>
              ...
              <el-radio-group v-model="advancedSettings.displayMode">
                <el-radio value="expanded"> 展开学习阶段下的课程 </el-radio>

                <el-radio value="collapsed"> 折叠学习阶段下的课程 </el-radio>
              </el-radio-group>
            </div>
          </div>
        </el-tab-pane>
