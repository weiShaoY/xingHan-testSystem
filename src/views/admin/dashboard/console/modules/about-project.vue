...
<template>
  <div
    class="art-card p-5 flex-b mb-5 max-sm:mb-4"
  >
    <div>
      <h2
      ...
      <div
        class="flex flex-wrap gap-3.5 max-w-150 mt-9"
      >
        <div
    ...
    <img
      class="w-75 max-md:!hidden"
      src="@imgs/draw/draw1.png"
      alt="draw1"
    >
  </div>
</template>
