...
<template>
  ...
  >
    ...
    >
      <div
        class="w-112 mr-5 max-md:w-full max-md:mr-0"
      >
        <div
          class="art-card-sm relative p-9 pb-6 overflow-hidden text-center"
        >
          <img
          ...
          <h2
            class="mt-5 text-xl font-normal"
          >
            {{ userInfo.userName }}
          </h2>
          ...
          <div
            class="w-75 mx-auto mt-7.5 text-left"
          >
            <div
              class="mt-2.5"
            >
          ...
          >
            ...
            <div
              class="flex flex-wrap justify-center mt-3.5"
            >
              <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="flex-c justify-end [&_.el-button]:!w-27.5"
            >
              <ElButton
                v-ripple
                type="primary"
