...
<template>
  ...
  >
    ...
    >
      <div
        class="p-5 text-center select-none"
      >
        <div
          class="mb-7.5 text-5xl"
        >
          🔒
        </div>

        <h1
          class="m-0 mb-5 text-3xl font-semibold text-danger"
        >
          系统已锁定
        </h1>

        <p
          class="max-w-125 m-0 text-lg leading-relaxed text-white"
        >
          检测到开发者工具已打开<br>
        ...
        <div
          class="mt-7.5 text-sm text-gray-400"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            class="mt-7.5 mb-3.5 text-base font-medium"
          >
            {{ userInfo.userName }}
          </div>
    ...
    >
      ...
      >
        ...
        <div
          class="mt-3 mb-3.5 text-base font-medium"
        >
          {{ userInfo.userName }}
        </div>
