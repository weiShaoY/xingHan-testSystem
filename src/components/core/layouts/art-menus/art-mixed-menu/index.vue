...
/**
   ...
   * @returns 是否为激活状态
   */
function isMenuItemActive(item: AppRouteRecord): boolean {
...
/**
   ...
   * 根据滚动位置显示/隐藏滚动按钮
   */
function handleScrollCore(): void {
...
/**
   ...
   */
function scroll(direction: ScrollDirection): void {
  if (!scrollbarRef.value?.wrapRef) { return }
...
<template>
  <div
    class="relative box-border flex-c w-full overflow-hidden"
  >
    <!-- 左侧滚动按钮 -->
    <div
        ...
        >
          ...
          >
            ...
            <div
              ...
              class="art-badge art-badge-mixed"
            />
          </div>
        </template>
      </div>
