...
<template>
  ...
  >
    <div
      class="mb-5 flex-b items-start px-5 pt-5"
    >
      <div>
        <p
          class="m-0 text-2xl font-medium leading-tight text-g-900"
        >
          {{ value }}
        </p>
      ...
      <div
        v-if="date"
        class="absolute bottom-5 right-5 text-xs text-g-600"
      >
        {{ date }}
      </div>
    </div>
