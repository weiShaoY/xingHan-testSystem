...
<template>
  ...
  >
    ...
    >
      <div
        class="relative w-full aspect-[16/10] overflow-hidden"
      >
        <ElImage
          :src="props.imageUrl"
          fit="cover"
        ...
        >
          ...
          >
            <div
              class="flex-cc w-full h-full bg-[#f5f7fa]"
            >
              <ElIcon>
                <Picture />
              </ElIcon>
      ...
      >
        ...
        <p
          class="m-0 mb-3 text-base font-medium"
        >
          {{ props.title }}
        </p>

        <div
          class="flex-c gap-4 text-xs text-g-600"
        >
          <span
            v-if="props.views"
            class="flex-c gap-1"
