...
// 根据 geoJson 数据准备地图数据
function prepareMapData(geoJson: {
...
// 构造 ECharts 配置项
function createChartOption(mapData: Array<Record<string, unknown>>) {
        ...
        itemStyle: {
          ...
          areaColor: {
            ...
            colorStops: [
              {
                offset: 0,
                color: 'rgba(147,235,248,0.3)',
              },
              {
                offset: 1,
                color: 'rgba(32,120,207,0.9)',
              },
            ],
          },
        ...
        ? [
            {
              ...
              data: [
                ...
                {
                  name: '上海',
                  value: [121.472644, 31.231706, 100],
                },
                {
                  name: '深圳',
                  value: [114.085947, 22.547, 100],
                },
              ],
            },
          ]
...
// 处理地图点击事件
function handleMapClick(params: Record<string, unknown>) {
