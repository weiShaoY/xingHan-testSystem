...
/**
   ...
   */
function getColumnVisibility(col: ColumnOption): boolean {
...
/**
   ...
   */
function updateColumnVisibility(col: ColumnOption, value: boolean | string | number): void {
...
const tableSizeOptions = [
  {
    value: TableSizeEnum.SMALL,
    label: t('table.sizeOptions.small'),
  },
  {
    value: TableSizeEnum.DEFAULT,
    label: t('table.sizeOptions.default'),
  },
  {
    value: TableSizeEnum.LARGE,
    label: t('table.sizeOptions.large'),
  },
]
...
/**
   ...
   * @returns 是否允许移动
   */
function checkColumnMove(event: any) {
  // 拖拽进入的目标 DOM 元素
...
<template>
  ...
  >
    ...
    <div
      class="flex-c md:justify-end max-md:mt-3 max-sm:!hidden"
    >
      <div
